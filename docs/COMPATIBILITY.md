...
| Hades | 1145360 | Supergiant engine (x64, D3D11, SDL2, FMOD, runtime HLSL via D3DCompiler_47) | ⛔ Not working | build 277, 2026-09-25 | Runs from a USB drive and draws its loading screen at 60 fps (1.7 ms per frame). Loading is slow because every file opened on the USB drive goes through the system file broker; the main menu has not been reached yet. Audio (FMOD) does not initialise yet. |
