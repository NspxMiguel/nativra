...
| Hades | 1145360 | Supergiant engine (x64, D3D11, SDL2, FMOD, runtime HLSL via D3DCompiler_47) | ⬜ Untested | build 286, 2026-09-26 | Gameplay not tested yet. Reaches its main menu at 60 fps from a USB drive ([screenshot](screenshots/hades-main-menu.png)); FMOD starts and loads its banks. Controller and sound in play still to be checked. |
